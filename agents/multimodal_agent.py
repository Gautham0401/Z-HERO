...
class BaseRequest(BaseModel):
    ...
    request_id: Optional[str] = Field(None, description="Unique ID for tracing the request across services.") # NEW
...
class SentimentResponse(BaseModel):
    sentiment: Literal["positive", "neutral", "negative", "mixed"] # Use Literal for fixed states
...
class GetKnowledgeGapsRequest(BaseModel):
    ...
    limit: int = Field(10, gt=0, le=100) # Maximum 100 gaps at once
